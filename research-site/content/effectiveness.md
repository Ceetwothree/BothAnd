...
description: Which interventions in LA's homelessness response are most and least effective, and what the evidence actually shows — by phase of the process.
status: researched
updated: 2026-08-01
subtitle: By phase of the process — what the evidence says is working, what isn't, and how confident we can actually be in that.
---
...
<h4>Strong evidence of cost-effectiveness</h4>
...
Cost comparisons consistently favor prevention: eviction-prevention assistance averages roughly **$2,500 per household**, versus up to **$5,000/month** for emergency shelter for the same family, and far more once someone has fallen into chronic homelessness and needs Permanent Supportive Housing (PSH). ([cost-of-homelessness summary](https://www.npscoalition.org/post/fact-sheet-cost-of-homelessness)) The *Just in Reach* jail-diversion program — a targeted form of prevention for people cycling through LA County jail — cost about **$6,202 per participant per year** and offset 50–100% of that cost through reduced jail, hospital, and shelter use. ([RAND](https://www.rand.org/pubs/research_reports/RRA1758-1.html))

**The catch:** cheap-per-unit doesn't mean effective-at-scale is actually being tracked. The 2024 California State Auditor found that of five major state homelessness programs examined — $13.7 billion combined — only **two** were determined "likely cost-effective," and three didn't produce enough data to judge effectiveness at all. ([CalMatters, April 2024](https://calmatters.org/housing/homelessness/2024/04/california-homelessness-spending/)) Prevention also reaches only a fraction of the people who become homeless each year in LA — it's the cheapest lever per person, and the least-scaled one.

## Street outreach — moderate reach, low direct conversion to housing

A California Policy Lab analysis of roughly 37,000 street outreach clients found only **17%** were enrolled in interim housing, Rapid Re-Housing, or PSH within one year of first contact. ([California Policy Lab](https://capolicylab.org/topics/homelessness/unsheltered-in-los-angeles-insights-from-street-outreach-services-data/))

<div class="callout callout-mixed">
<h4>Historical baseline: outreach missed its own targets</h4>
...
Outreach is the necessary front door — it's typically where HMIS enrollment begins — but on its own it converts a modest share of contacts into housing placements.

## Interim / shelter housing — the weakest link in the pipeline

<div class="callout callout-fails">
<h4>Weak evidence it functions as a bridge</h4>
...
The same audit found roughly **1 in 4 city-funded shelter beds sat unused** — an estimated **$218 million** wasted over five years — even though nearly **1 in 3** people who wanted a bed in FY22–23 couldn't get one. That combination (empty beds *and* unmet demand at the same time) points to a matching/operations failure, not a lack of need. ([LA City Controller](https://controller.lacity.gov/landings/interim-housing-audit))

Interim housing currently functions better as crisis stabilization and encampment reduction than as a housing pipeline. See <a href="breaks.html">Where &amp; Why It Breaks</a> for how this bottleneck is directly connected to the 2026 rise in the homeless count.

## Permanent Supportive Housing (PSH) — strong evidence for retention, real equity gap

<div class="callout callout-works">
<h4>Strong evidence of effectiveness</h4>
...
<div class="callout callout-mixed">
<h4>Documented racial disparity within an otherwise strong-performing model</h4>
...
## Rapid Re-Housing (RRH / "Time-Limited Subsidy") — mixed, with a real mismatch problem

RRH provides a short-term (typically ≤24 month) rental subsidy plus light-touch services — cheaper and faster to scale than PSH. Where it fits, it works: California Policy Lab found it "substantially reduced long-term homelessness," with benefits persisting after the subsidy ended for many participants; the *Breaking Barriers* RRH program for justice-involved individuals found **83%** of participants remained housed one year after move-in. ([RAND](https://www.rand.org/pubs/research_reports/RRA4755-1.html))

<div class="callout callout-mixed">
<h4>The mismatch: RRH assumes people can absorb full market rent once the clock runs out</h4>
...
This isn't hypothetical at scale — it's the single largest driver of the system's 2026 reversal. See <a href="breaks.html">Where &amp; Why It Breaks</a>.

## Housing First as a model — the most contested part of the evidence base

<div class="callout callout-works">
<h4>Strong evidence: retention and cost savings</h4>
...
<div class="callout callout-mixed">
<h4>Disputed: whether housing without mandated treatment adequately serves the most severe cases</h4>
...
| Phase | Evidence rating | Core finding |
|---|---|---|
| Prevention / diversion | Strong (cost-effectiveness) | 14.5% return-to-homelessness rate, but reaches a small share of inflow |
| Street outreach | Weak–moderate | ~17% of contacts convert to housing within a year |
| Interim / shelter housing | Weak | Under 20% exit to permanent housing; more likely to exit to the street |
| Permanent Supportive Housing | Strong (with equity gap) | 94% one-year retention; racial disparity in returns to homelessness |
| Rapid Re-Housing | Mixed | Works for short-term financial shocks; fails when used for people who needed PSH |
| Housing First (as a model) | Strong on retention / disputed on acuity fit | Retention & cost evidence strong; treatment-mandate debate unresolved |

<div class="callout callout-question">
<h4>Related</h4>
This evidence connects directly to a live, current failure: see <a href="breaks.html">Where &amp; Why It Breaks</a> for how the RRH funding pause specifically reversed two years of declining homelessness counts in 2026.
</div>
